  ...
  methods: {
    ...
    drawCertificate() {
      ...
      certificateImg.onload = () => {
        ...
        ctx.fillStyle = "#000";
        ctx.fillText(cardDetail.name || "", width / 2 - 80, height / 2 - 126);
        ...
        if (cardDetail.created_at) {
          try {
            ...
            if (date.isValid()) {
              ...
              ctx.font = '10px "SimSun"';
              ctx.fillStyle = "#000";
              ctx.fillText(createdYear, width / 2 + 50, height - 73);
              ctx.fillText(createdMonth, width / 2 + 87, height - 73);
              ctx.fillText(createdDay, width / 2 + 106, height - 73);
            }
          } catch (e) {
      ...
      try {
        if (this.cardDetail.id == 1) {
          certificateImg.src = require("../../assets/img/invite/dasda.jpg");

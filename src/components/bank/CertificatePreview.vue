  ...
  methods: {
    ...
    drawCertificate() {
      ...
      certificateImg.onload = () => {
        ...
        ctx.fillText(cardDetail.name || '', width / 2 - 130, height / 2 - 90);
        ...
        if (cardDetail.created_at) {
          try {
            ...
            if (date.isValid()) {
              ...
              ctx.font = '7px "SimSun"';
              ctx.fillStyle = '#333333';
              ctx.fillText(createdYear, width / 2 + 55, height - 80);
              ctx.fillText(createdMonth, width / 2+92, height - 80);
              ctx.fillText(createdDay, width / 2 + 117, height - 80);
            }
          } catch (e) {
      ...
      try {
        if(this.cardDetail.id==1){
          certificateImg.src = require('../../assets/img/invite/jk.jpg');
        }
        else if(this.cardDetail.id==2){
          certificateImg.src = require('../../assets/img/invite/tjk.jpg');
        }
        else if(this.cardDetail.id==3){
          certificateImg.src = require('../../assets/img/invite/zsk.jpg');
        }

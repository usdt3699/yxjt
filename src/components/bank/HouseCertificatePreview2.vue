<template>
  <div>
    ...
    >
      <div class="certificate-preview-container bg-white" @click.stop>
        ...
        <div class="text-red-400 font-bold mb-2">
          请把该门票保存图片发送至官方群聊进行报备
        </div>
        <div class="certificate-preview-footer">
          <div class="save-button" @click="saveCertificate">保存门票</div>
        </div>
      </div>
    </van-overlay>
  ...
  methods: {
    ...
    drawCertificate() {
      ...
      certificateImg.onload = () => {
        ...
        // 绘制姓名（尊敬的后面）
        ctx.font = '60px "SimSun"';
        ctx.fillStyle = "#f1d78e";
        ctx.fillText(carDetail.get_name || "", 540, 770);
      ...
      try {
        certificateImg.src = require("../../assets/img/mp.jpg");

  ...
  methods: {
    ...
    drawCertificate() {
      ...
      certificateImg.onload = () => {
        ...
        ctx.fillText(cardInfo.real_name || cardInfo.name || "", 320, 450);

        ctx.fillText(
          dayjs(this.relu?.created_at || new Date()).format("YYYY"),
          1500,
          1156
        );
        ctx.fillText(
          dayjs(this.relu?.created_at || new Date()).format("MM"),
          1715,
          1156
        );
        ctx.fillText(
          dayjs(this.relu?.created_at || new Date()).format("DD"),
          1850,
          1156
        );
      ...
      try {
        certificateImg.src = require("../assets/img/zs.jpg");

    ...
    <div class="w-full relative">
      ...
      <div class="absolute top-0 left-0 right-0 w-full">
        ...
        <div class="content-container mx-4 rounded-lg p-5">
          <div class="receipt-title">车辆锁定押金收据</div>

          <div class="receipt-content">
            <p>今收到（<span class="underdashline">{{ receiverName }}</span>）：</p>

            <p>车辆锁定押金人民币（大写）<span class="underdashline">{{ convertToChinese(depositAmount) }}</span>万<span
        ...
        <div class="info-container">
          <p class="price-text">
            说明：需缴纳{{price}}元车辆锁定押金费，未缴纳车辆押金费视为自动放弃该车辆认领资格，车辆锁定押金费将在缴纳后可在个人中心 押金处提现。</p>
    ...
    getRouteParams() {
      ...
      if (this.$route.query) {
        ...
        if(this.status>1){
          ...
          this.vehicleName = this.$route.query.name || '';
        }
      }
    },

...
export default {
  ...
  data() {
    return {
      id: this.$route.query.goldId,
      address: {
        name: this.$route.query.get_name,
        tel: this.$route.query.get_mobile,
        addressDetail: this.$route.query.get_address,
        isDefault: false,
      },
    };
  },
